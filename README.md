...
449 條四字成語，依年段分四級。**每一條都有注音、解釋、例句**；三級以上每條有易錯字，
四級每條再多一句誤用例句。這兩樣是台灣成語考題的核心，也是「抓錯字」「用法○✕」兩個題型的原料。
...
**想多養，成語要練得更難。** 第 2 隻要三級熟練 50 條；第 3 隻要四級熟練 50 條、且挑戰模式近 7 天
