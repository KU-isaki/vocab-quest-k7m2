...
907 條四字成語。**目標是國中會考**，畫面上不分國小國中：範圍只有「會考重點」和「全部」兩種，
...
| 會考 | [Hamer 老師的「歷屆會考成語」與「426 成語列表」](https://sites.google.com/view/hamerinmljh/) | 458 | 解釋、特殊注音（破音字）、字詞解釋；沒有例句與完整注音 |

**會考重點 = 會考批次 458 條 + 前四級裡打了會考標籤的 69 條，共 527 條**（那兩份來源出現過的都算）。
會考批次只做格式整理與去重（來源裡的錯字條目如「急公好利」「愴然替下」拿掉）；沒例句的成語不出例句填空。
...
近義反義指到不存在的、單向連結、每批條數不對、解釋重複（就是靠這條抓到來源的錯字條目）。**第一階只收四字成語**，拼成語的 8 格機制靠它。
