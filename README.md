...
| 看中文 → **點字母拼英文** | 打散的字母方塊點選，可退格 | 手機打字太痛苦，會直接勸退 |
...
當日累積題數換遊戲時間，給的是**累計到該階的總額**，所以分三次做 10 題和一次做 30 題拿到的一樣多：
...
const TIERS  = [{n:10, m:2}, {n:20, m:4}, {n:30, m:15}];   // 當日題數 → 可換的分鐘數
